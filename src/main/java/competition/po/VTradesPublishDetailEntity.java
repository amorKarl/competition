 ...
 */
@Entity
@Table(name = "v_trades_publish_detail", schema = "competition", catalog = "")
public class VTradesPublishDetailEntity {
    ...
    public boolean equals(Object o) {
        ...
        VTradesPublishDetailEntity that = (VTradesPublishDetailEntity) o;
